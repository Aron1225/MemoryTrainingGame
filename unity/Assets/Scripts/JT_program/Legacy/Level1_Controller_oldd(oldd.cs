...
public class Level1_Controller_ooo : MonoBehaviour
{
//	//執行GameStart的方法
...
//
//		DB.ResultScale = new Vector3 (140, 140, 0);
//
//		DB.ResultPosition = new Vector3 (0, 0, 220);
//
//		DB.Compare = true;
//
//		//載入UFO
...
//		GameObject go = GetResultIcon (child);
//
...
//			go.SetActive (true);
//			StartCoroutine (hide (1f, go));
////			Destroy (go, 1f);
//		}
//	}
//
//	IEnumerator hide (float time, GameObject go)
//	{
//		yield return new WaitForSeconds (time);
//		go.SetActive (false);
//	}
//
//	GameObject BingoCache;
//	GameObject ErrorCache;
//
//	private GameObject GetResultIcon (GameObject child)
//	{
//		GameObject icon;
//		if (child == UI.GameObject_Bingo) {
//			if (BingoCache == null)
//				BingoCache = GameObject.Instantiate (child) as GameObject;
//			icon = BingoCache;
//		} else {
//			if (ErrorCache == null)
//				ErrorCache = GameObject.Instantiate (child) as GameObject;
//			icon = ErrorCache;
//		}
//		return icon;
//	}
